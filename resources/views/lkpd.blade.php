...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; transition: all 0.3s ease; }
        ...
        .mission-header { display: flex; align-items: center; gap: 15px; margin-bottom: 25px; }
        .mission-icon { width: 45px; height: 45px; background: #eff6ff; color: var(--accent); display: flex; align-items: center; justify-content: center; border-radius: 12px; font-size: 20px; }
        .mission-card h2 { font-family: 'Poppins'; margin: 0; font-size: 22px; color: var(--primary); }

        .scenario-box { background: #f8fafc; padding: 20px; border-radius: 12px; border-left: 4px solid var(--accent); margin-bottom: 25px; font-size: 14px; }

        .table-wrapper { overflow-x: auto; margin: 25px 0; }
        table { width: 100%; border-collapse: separate; border-spacing: 0; }
        th { background: #f1f5f9; padding: 15px; text-align: left; font-size: 12px; font-weight: 700; color: var(--text-muted); text-transform: uppercase; border-bottom: 2px solid #e2e8f0; }
        ...
        .btn-verify { background: var(--primary); color: white; border: none; padding: 12px 25px; border-radius: 10px; cursor: pointer; font-weight: 600; font-size: 13px; margin-top: 15px; }
        .btn-verify:hover { background: var(--accent); transform: translateY(-2px); }

        .alert { display: none; margin-top: 20px; padding: 15px; border-radius: 10px; font-size: 14px; font-weight: 500; align-items: center; gap: 10px; }
        ...
        .reflection-card { background: white; padding: 40px; border-radius: 20px; text-align: center; border: 1px solid #e2e8f0; }
        .emoji-container { display: flex; justify-content: center; gap: 40px; margin: 30px 0; }
        .emoji-item { cursor: pointer; font-size: 40px; filter: grayscale(1); opacity: 0.4; display: flex; flex-direction: column; align-items: center; }
        .emoji-item.active { filter: grayscale(0); opacity: 1; transform: scale(1.15); }
        .emoji-label { display: block; font-size: 11px; margin-top: 10px; color: var(--text-muted); font-weight: 700; text-transform: uppercase; }

        textarea { width: 100%; height: 100px; border: 1px solid #e2e8f0; border-radius: 12px; padding: 15px; outline: none; resize: none; margin-top: 15px; font-family: inherit; font-size: 14px; }

        .btn-submit { background: var(--success); color: white; border: none; width: 100%; padding: 20px; border-radius: 15px; font-size: 18px; font-weight: 700; cursor: pointer; margin-top: 40px; display: flex; align-items: center; justify-content: center; gap: 15px; }
        .btn-submit:hover { transform: translateY(-3px); background: #059669; }
